...
public class Base {
	...
	protected static String BASE_DIR = Paths.get(".").toAbsolutePath().normalize().toString();
	protected static String inputFilePath;
	protected static boolean osFlag = System.getProperty("os.name").contains("linux") || System.getProperty("os.name").contains("Linux") ;
